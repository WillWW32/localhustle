...
const SCOPES = ['dm.write', 'dm.read', 'tweet.read', 'tweet.write', 'like.write', 'users.read', 'offline.access']
...
export function getAuthorizationUrl(athleteId: string, codeChallenge: string): string {
...
function getOAuthConfig(): OAuthConfig {
  ...
  if (!clientId || !clientSecret || !appUrl) {
    throw new Error('Missing required environment variables: X_CLIENT_ID, X_CLIENT_SECRET, NEXT_PUBLIC_APP_URL')
  }
